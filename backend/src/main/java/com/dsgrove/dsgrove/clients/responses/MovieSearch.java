...
public class MovieSearch {
    ...
    // Construtor
    public MovieSearch (boolean adult, String backdropPath, List<Integer> genreIds, int id, String originalLanguage,
...
class Page {
    ...
    // Construtor
    public Page(int page, List<MovieSearch> results, int totalPages, int totalResults) {
        this.page = page;
